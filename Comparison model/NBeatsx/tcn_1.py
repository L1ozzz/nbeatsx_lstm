...
class Chomp1d(nn.Module):
    """Chomps the last `chomp_size` elements of a tensor."""
...
class TemporalBlock(nn.Module):
    """A single temporal block in the TCN model."""
...
class TemporalConvNet(nn.Module):
    ...
    def __init__(self, num_inputs, num_channels, kernel_size=8, dropout=0.2):
